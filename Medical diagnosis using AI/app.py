 ...
 #           <style>
  ...
  #          footer {visibility: visible;}
   #         header {visibility: visible;}
    #        </style>
     #       """
#st.markdown(visible_st_style, unsafe_allow_html=True)

# Adding Background Image
background_image_url = "https://png.pngtree.com/thumb_back/fw800/background/20190221/ourmid/pngtree-world-diabetes-day-diabetes-medical-health-image_18558.jpg"  # Replace with your image URL
...
def display_input(label, tooltip, key, type="text"):
    bold_label=f"**{label}**"
    if type == "text":
        return st.text_input(bold_label, key=key, help=tooltip)
    elif type == "number":
        return st.number_input(bold_label, key=key, help=tooltip, step=1)
